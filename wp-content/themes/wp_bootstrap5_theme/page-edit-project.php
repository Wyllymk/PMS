        ...
        <div class="col">
            ...
            <form class="form card shadow p-4"action="" method="post">
                ...
                <div class="form-group mt-2">
                    ...
                    <input type="text" class="form-control" id="title" name="title" placeholder="Project Title" value="<?php echo get_the_title(); ?>">
                </div>
                <div class="form-group mt-2">
                    <label for="content"><?php _e('Enter the Project Description:', 'mytextdomain'); ?></label>
                    <textarea rows="3" class="form-control" id="content" name="content" placeholder="Enter Project Description here"><?php echo get_the_content(); ?></textarea>
                </div>
                <div class="form-group mt-2">
