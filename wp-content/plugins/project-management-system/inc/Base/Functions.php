 ...
 */
 ...
 public function register(){
	...
	add_action( 'cmb2_admin_init', array($this, 'yourprefix_register_demo_metabox') );

	add_action( 'cmb2_admin_init', array($this, 'yourprefix_register_about_page_metabox') );
	...
	add_action( 'cmb2_init', array($this, 'yourprefix_register_rest_api_box') );
